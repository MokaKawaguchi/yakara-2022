...
#pragma warning restore SA1649 // File name should match first type name
    ...
    public interface INetworkVarMessagePackFormatter<T> : IMessagePackFormatter<T>
    {
        /// <summary>
        /// The number of fields needed to be serialized
        /// </summary>
        int FieldCount { get; }
        ...
        /// The number of fields needed to be serialized
        /// </summary>
        ulong GetDirtyMask(T before, T after, MessagePackSerializerOptions options);
        ...
        /// <param name="value">The value to be serialized.</param>
        /// <param name="options">The serialization settings to use, including the resolver to use to obtain formatters for types that make up the composite type <typeparamref name="T"/>.</param>
        void SerializeNetworkVar(ref MessagePackWriter writer, T value, MessagePackSerializerOptions options, ulong dirtyMask);

        /// <summary>
        /// Deserializes a value to an existing object.
        /// </summary>
        /// <param name="reader">The reader to deserialize from.</param>
        /// <param name="options">The serialization settings to use, including the resolver to use to obtain formatters for types that make up the composite type <typeparamref name="T"/>.</param>
        /// <returns>The deserialized value.</returns>
        void DeserializeNetworkVar(ref MessagePackReader reader, MessagePackSerializerOptions options, ref T instance, ulong dirtyMask);
    }
}
